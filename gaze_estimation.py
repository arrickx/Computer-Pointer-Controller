...
class Model_Gaze_Estimation:
    ...
    def predict(self, left_eye_image, right_eye_image, head_pose_angle):
        ...
        mouse_coords, gaze_vector = self.preprocess_output(outputs, head_pose_angle)
    ...
    def preprocess_output(self, outputs, head_pose_angle):
        ...
        x_val = gaze_vector[0] * cosine + gaze_vector[1] * sine
        y_val = -gaze_vector[0] *  sine+ gaze_vector[1] * cosine
